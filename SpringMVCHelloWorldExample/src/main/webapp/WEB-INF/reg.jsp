   ...
   <h1  style="text-align:center">Registration form</h1>  
        ...
        <form name="Register" ng-submit="funcSave()" modelAttribute="Register" action="login.do" >  
              <div class="input-container">
				...
				<input name="firstName"  class="input-field"  placeholder="FirstName" maxlength="60" ng-pattern="/^[a-zA-Z. ]*[a-zA-Z]{1,60}$/"   ng-model="firstName" required />   
                
                 <br/>                  
                 <span style="color:red" ng-show="Register.firstName.$dirty && SRegister.firstName.$invalid" class="ng-hide">   
              ...
              <div class="input-container">
				<i class="fa fa-user icon">  </i>
                <input name="lastName"  class="input-field"  placeholder="LastName" maxlength="60" ng-pattern="/^[a-zA-Z. ]*[a-zA-Z]{1,60}$/" ng-model="lname" required/>   
                 <br/>                  
              ...
              <div class="input-container">
                ...
                <input name="email" class="input-field"   placeholder="Email Id" maxlength="100" ng-pattern="/^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/"  ng-model="email" required/>      
          ...
          <input name="phone" class="input-field"  placeholder="Phone number"  maxlength="10" data-ng-pattern="/^[7-9][0-9]{9}$/" data-ng-model="mobileno" required/>   
                 <br/>                      
                ...
                <input name="projID" class="input-field"   placeholder="Project Id"   ng-model="id" required/>      
                 <select >
			   ...
			   <div class="input-container">
				<i class="fa fa-group icon"></i>
                <input name="projName" class="input-field"   placeholder="project Name"  maxlength="60" ng-pattern="/^[a-zA-Z. ]*[a-zA-Z]{1,60}$/"  ng-model="pname" required/>      
			   ...
			   <div class="input-container">
				<i class="fa fa-user icon"></i>
            <input name="userID" class="input-field"  placeholder="User Id" maxlength="100"  ng-pattern="/^[a-zA-Z. ]*[a-zA-Z0-9]{1,60}$/" ng-model="uid" required/>      
			   ...
			   <div class="input-container">
                ...
                <input name="password" class="input-field" type="password" placeholder="Password" maxlength="100" ng-pattern="/^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$/"  ng-model="pass" required />      
